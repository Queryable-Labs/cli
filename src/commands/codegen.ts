...
function convertPublishedTypeToFieldType(
    ...
    if (fieldType.hasOwnProperty('boolean')) {
        type = 'boolean'
        required = fieldType.boolean
    } else if (fieldType.hasOwnProperty('int8')) {
        type = 'int8'
        required = fieldType.int8
    } else if (fieldType.hasOwnProperty('int16')) {
        type = 'int16'
        required = fieldType.int16
    } else if (fieldType.hasOwnProperty('int32')) {
        type = 'int32'
        required = fieldType.int32
    } else if (fieldType.hasOwnProperty('int64')) {
        type = 'int64'
        required = fieldType.int64
    } else if (fieldType.hasOwnProperty('uint8')) {
        type = 'uint8'
        required = fieldType.uint8
    } else if (fieldType.hasOwnProperty('uint16')) {
        type = 'uint16'
        required = fieldType.uint16
    } else if (fieldType.hasOwnProperty('uint32')) {
        type = 'uint32'
        required = fieldType.uint32
    } else if (fieldType.hasOwnProperty('uint64')) {
        type = 'uint64'
        required = fieldType.uint64
    } else if (fieldType.hasOwnProperty('float32')) {
        type = 'float32'
        required = fieldType.float32
    } else if (fieldType.hasOwnProperty('float64')) {
        type = 'float64'
        required = fieldType.float64
    } else if (fieldType.hasOwnProperty('decimal128')) {
        type = 'decimal128'
        required = fieldType.decimal128[0]
        precision = fieldType.decimal128[1]
        scale = fieldType.decimal128[2]
    } else if (fieldType.hasOwnProperty('decimal256')) {
        type = 'decimal256'
        required = fieldType.decimal256[0]
        precision = fieldType.decimal256[1]
        scale = fieldType.decimal256[2]
    } else if (fieldType.hasOwnProperty('biginteger')) {
        type = 'biginteger'
        required = fieldType.biginteger[0]
        size = fieldType.biginteger[1]
    } else if (fieldType.hasOwnProperty('bigdecimal')) {
        type = 'bigdeimal'
        required = fieldType.bigdecimal[0]
        precision = fieldType.bigdecimal[1]
        scale = fieldType.bigdecimal[2]
    } else if (fieldType.hasOwnProperty('time32')) {
        type = 'time32'
        required = fieldType.time32[0]
        unit = fieldType.time32[1]
    } else if (fieldType.hasOwnProperty('time64')) {
        type = 'time64'
        required = fieldType.time64[0]
        unit = fieldType.time64[1]
    } else if (fieldType.hasOwnProperty('date32')) {
        type = 'date32'
        required = fieldType.date32
    } else if (fieldType.hasOwnProperty('date64')) {
        type = 'date64'
        required = fieldType.date64
    } else if (fieldType.hasOwnProperty('binary')) {
        type = 'binary'
        required = fieldType.binary
    } else if (fieldType.hasOwnProperty('fixedsizebinary')) {
        type = 'fixedsizebinary'
        required = fieldType.fixedsizebinary[0]
        size = fieldType.fixedsizebinary[1]
    } else if (fieldType.hasOwnProperty('largebinary')) {
        type = 'largebinary'
        required = fieldType.largebinary
    } else if (fieldType.hasOwnProperty('string')) {
        type = 'string'
        required = fieldType.string
    } else if (fieldType.hasOwnProperty('largestring')) {
        type = 'largestring'
        required = fieldType.largestring
    } else if (fieldType.hasOwnProperty('list')) {
        type = 'list'
        required = fieldType.list[0]

        subType = convertPublishedTypeToFieldType(fieldType.list[1])
    } else if (fieldType.hasOwnProperty('struct')) {
        type = 'struct'
